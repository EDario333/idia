    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_es', models.CharField(default=None, max_length=100, unique=True, validators=[django.core.validators.MinLengthValidator(2), django.core.validators.MaxLengthValidator(100)], verbose_name='Name')),
                ('name_en', models.CharField(default=None, max_length=100, unique=True, validators=[django.core.validators.MinLengthValidator(2), django.core.validators.MaxLengthValidator(100)], verbose_name='Name')),
            ],
            options={
                'verbose_name': 'Axis',
                'verbose_name_plural': 'Axises',
            },
        ),
    ]
