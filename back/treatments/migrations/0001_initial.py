    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_es', models.CharField(default=None, max_length=254, unique=True, validators=[django.core.validators.MinLengthValidator(3), django.core.validators.MaxLengthValidator(254)], verbose_name='Name')),
                ('name_en', models.CharField(default=None, max_length=254, unique=True, validators=[django.core.validators.MinLengthValidator(3), django.core.validators.MaxLengthValidator(254)], verbose_name='Name')),
            ],
            options={
