    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default=None, max_length=10, validators=[django.core.validators.MinLengthValidator(1), django.core.validators.MaxLengthValidator(10)], verbose_name='Code')),
            ],
            options={
                'verbose_name': 'Sympton',
                'verbose_name_plural': 'Symptons',
            },
        ),
    ]
